...
over \(0 \le t \le 1\)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{k}{def} \PY{n+nf}{a811}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{n}{x}\PY{p}{)}\PY{p}{:}
...
curve.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{def} \PY{n+nf}{roundoff}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{i}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{:}
...
the Euler method.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{heun\PYZus{}method}\PY{p}{(}\PY{n}{a}\PY{p}{,}\PY{n}{x0}\PY{p}{,}\PY{n}{delta}\PY{p}{)}\PY{p}{:}
            \PY{n}{t} \PY{o}{=}\PY{p}{[}\PY{n}{delta}\PY{o}{*}\PY{n}{x} \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{n}{delta}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}
            \PY{n}{y} \PY{o}{=}\PY{p}{[}\PY{n}{x0}\PY{p}{]}
            \PY{k}{for} \PY{n}{tn} \PY{o+ow}{in} \PY{n}{t}\PY{p}{[}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{:}
...
with the Heun method (1.12) as its starting routine.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{adams\PYZus{}bashford\PYZus{}method}\PY{p}{(}\PY{n}{a}\PY{p}{,}\PY{n}{x0}\PY{p}{,}\PY{n}{delta}\PY{p}{)}\PY{p}{:}
            \PY{n}{t} \PY{o}{=}\PY{p}{[}\PY{n}{delta}\PY{o}{*}\PY{n}{x} \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{int}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{n}{delta}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{]}
            \PY{n}{y} \PY{o}{=}\PY{p}{[}\PY{n}{x0}\PY{p}{]}
...
\(\frac{dx}{dt} = -x , \ x(0) = 1\)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{a817}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{n}{x}\PY{p}{)}\PY{p}{:}
...
discretization error at time = 0.5 against \(\log_2 \Delta\)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{k}{def} \PY{n+nf}{a821}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{n}{x}\PY{p}{)}\PY{p}{:}
...
with equal length time steps \(\Delta = 2^{-2} , \cdots , 2^{-7}\)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{k}{def} \PY{n+nf}{runge\PYZus{}kutta\PYZus{}4th}\PY{p}{(}\PY{n}{x0}\PY{p}{,}\PY{n}{t0}\PY{p}{,}\PY{n}{tn}\PY{p}{,}\PY{n}{delta}\PY{p}{,}\PY{n}{a}\PY{p}{)}\PY{p}{:}
...
\([-5 \times 10^{-5} , 5 \times 10^{-5}]\) using 40 equal subintervals.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{}合ってるか分からない}
...
\(R_{1/\Delta}\)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{x1} \PY{o}{=} \PY{l+m+mf}{0.4}
...
intervals for the mean value of the error against \(\Delta\)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{x1} \PY{o}{=} \PY{l+m+mf}{0.4}
         \PY{n}{x2} \PY{o}{=} \PY{l+m+mf}{0.6}
         \PY{n}{t0} \PY{o}{=} \PY{l+m+mi}{0}
         \PY{n}{t1} \PY{o}{=} \PY{l+m+mi}{1}
